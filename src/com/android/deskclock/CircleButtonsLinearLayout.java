...
public class CircleButtonsLinearLayout extends LinearLayout {
    ...
    public int mCircleTimerViewId;
    public int mLeftButtonId;
    public int mRightButtonId;
    public int mStopButtonId;
    public int mLabelId;
    public int mLabelTextId;
    public float mLeftButtonPadding;
    public float mRightButtonPadding;
    public float mStrokeSize;
    public float mDiamOffset;
    public CircleTimerView mCtv;
    public ImageButton mLeft, mRight;
    public TextView mStop;
    public FrameLayout mLabel;
